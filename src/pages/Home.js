...
const Home = () => {
  ...
  return (
    <div className="bg-slate-950">
      <div className="mx-[5%] flex flex-col items-center bg-slate-950 px-[5%] text-center">
        <h1 className="mt-[120px] mb-[10px] text-[50px] font-normal animate-fade-in-1 md:text-[80px]">Peter Bignold</h1>
        <h2 className="text-[20px] font-light text-neutral-400 animate-fade-in-2 md:text-[30px]">Computer Scientist &#x2022; Software Developer &#x2022; Digital Artist</h2>
      ...
      <div className="flex flex-col items-center bg-slate-950 text-center">
