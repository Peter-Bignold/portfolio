...
const ProjectCard = ({to, logo, title, meta, description, previews, className = ''}) => (
  <Link
    className={`mt-4 flex w-full max-w-[1256px] flex-col rounded-[5px] bg-neutral-50 p-5 text-left text-black shadow-soft transition duration-200 hover:bg-neutral-100 md:w-auto ${className}`}
    to={to}
  >
