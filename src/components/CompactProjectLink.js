...
const CompactProjectLink = ({to, logo, title, meta}) => (
  <Link
    className="m-2 flex w-full flex-col rounded border border-slate-800 bg-slate-800/50 px-6 py-5 text-left text-neutral-100 shadow-panel transition duration-200 hover:bg-slate-800 md:w-auto md:min-w-72"
    to={to}
  >
