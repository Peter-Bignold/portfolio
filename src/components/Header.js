...
const Header = () => {
  ...
  return (
    <div className="fixed top-0 z-[1000] m-0 w-full">
      <header className="flex h-[60px] items-center justify-center border-b border-slate-800/80 bg-slate-900/50 px-[6%] py-[10px] text-[30px] text-neutral-100 shadow-soft backdrop-blur md:justify-between">
